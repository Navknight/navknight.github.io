  ...
  const runOverclockSequence = (cmdLine) => {
    ...
    const sequence = isSudo
      ? [
          ...
          {
            delay: 50,
            line: "  │  PERFORMANCE BOOST v3.2.1 — KERNEL MODULE   │",
          },
          {
            delay: 50,
            line: "  └─────────────────────────────────────────────┘",
          ...
          {
            delay: 150,
            line: "  ⚡ L1 prefetch aggression: conservative → extreme",
          },
          {
            delay: 150,
            line: "  ⚡ Memory timings:        CL16 → CL12 (risky)",
          },
          { delay: 100, line: "" },
          ...
          {
            delay: 100,
            line: "  ✓ Prefetch accuracy: 80% → 94% (DAP engaged).",
          },
          { delay: 200, line: "" },
        ]
      : [
          ...
          {
            delay: 150,
            line: "  [MEM] Coalescing: enabled (128B transactions)",
          },
          { delay: 100, line: "" },
      ...
      <div className="centered-container grid lg:grid-cols-12 gap-12 items-center z-10">
        ...
        <div className="lg:col-span-5 flex flex-col items-start text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent-indigo/10 border border-accent-indigo/20 mb-6 animate-fade-up">
            ...
            <span className="font-mono text-[10px] uppercase tracking-wider text-accent-indigo font-bold">
              Software Engineer
            </span>
          </div>
          ...
          <p
            className="text-lg md:text-xl font-medium text-text-secondary mb-6 animate-fade-up"
            style={{ animationDelay: "100ms" }}
          >
            Multi-tenant backends, custom browser forks, and GPU memory
            research.
          </p>

          <p
            className="text-sm text-text-muted leading-relaxed mb-8 max-w-lg animate-fade-up"
            style={{ animationDelay: "200ms" }}
          >
            Software Engineer at{" "}
            <span className="text-text font-semibold">Zscaler</span> (via
            SquareX). Previously built dead-block aware prefetchers in MGPUsim,
            parallelized sparse Tucker decomposition with OpenMP, and SWG
            bypasses at DEF CON 32.
          </p>

          <div
            className="flex flex-wrap gap-4 w-full animate-fade-up"
        ...
        <div
          className="lg:col-span-7 w-full animate-fade-up"
        ...
        >
          <div className="rounded-2xl overflow-hidden glass border border-white/5 shadow-2xl flex flex-col h-[420px]">
              ...
              {activeTab === "terminal" && (
                ...
                >
                  ...
                  <div className="flex items-center mt-2 shrink-0">
                    <span className="text-accent-indigo font-bold mr-2">
                      {" "}
                      ❯
                    </span>
                    <input
                      ...
                      autoComplete="off"
                    />
                    <span className="animate-blink text-accent-indigo/80">
                      ▊
                    </span>
                  </div>
                </div>
              ...
              {activeTab === "cuda" && (
                <div className="text-left select-text whitespace-pre overflow-x-auto text-[11px] sm:text-[12px]">
                  <p className="text-text-muted">
                    // MGPUsim Strided Prefetcher — prefetch.go
                  </p>
                  <p>
                    <span className="text-accent-purple">package</span>{" "}
                    <span className="text-accent-cyan">prefetcher</span>
                  </p>
                  <p>&nbsp;</p>
                  <p>
                    ...
                    <span className="text-accent-purple">struct</span> &#123;
                  </p>
                  <p>
                    {" "}
                    strideTable []
                    <span className="text-accent-cyan">strideEntry</span>
                  </p>
                  <p>
                    {" "}
                    confidence <span className="text-accent-cyan">int</span>
                  </p>
                  <p>
                    {" "}
                    threshold <span className="text-accent-cyan">int</span>
                  </p>
                  <p>&#125;</p>
                  <p>&nbsp;</p>
                  <p>
                    <span className="text-accent-purple">func</span> (p *
                    <span className="text-accent-indigo">
                      StridedPrefetcher
                    </span>
                    ) <span className="text-accent-indigo">Lookup</span>(addr{" "}
                    <span className="text-accent-cyan">uint64</span>) *
                    <span className="text-accent-cyan">PrefetchReq</span> &#123;
                  </p>
                  <p> entry := p.findEntry(addr)</p>
                  <p>
                    {" "}
                    <span className="text-accent-purple">if</span> entry =={" "}
                    <span className="text-accent-purple">nil</span> &#123;
                  </p>
                  <p> p.allocEntry(addr)</p>
                  <p>
                    {" "}
                    <span className="text-accent-purple">return nil</span>
                  </p>
                  <p> &#125;</p>
                  <p>&nbsp;</p>
                  ...
                  <p>
                    {" "}
                    <span className="text-accent-purple">if</span> stride ==
                    entry.stride &#123;
                  </p>
                  <p> entry.confidence++</p>
                  <p>
                    {" "}
                    &#125; <span className="text-accent-purple">else</span>{" "}
                    &#123;
                  </p>
              ...
              {activeTab === "json" && (
                <div className="text-left select-text whitespace-pre overflow-x-auto text-[11px] sm:text-[12px] text-text-secondary">
                  ...
                  <p>
                    ...
                    <span className="text-accent-emerald">"Abhinav Gupta"</span>
                    ,
                  </p>
                  <p>
                    {" "}
                  ...
                  <p>
                    {" "}
                    <span className="text-accent-cyan">"org"</span>:{" "}
                    <span className="text-accent-emerald">
                      "Zscaler (via SquareX)"
                    </span>
                    ,
                  ...
                  <p>
                    {" "}
                    <span className="text-accent-cyan">"domains"</span>: [
                  </p>
                  <p>
                    {" "}
                    <span className="text-accent-emerald">
                      "GPU Memory Systems (MGPUsim)"
                    </span>
                    ,
                  </p>
                  <p>
                  ...
                  <p>
                    {" "}
                    <span className="text-accent-emerald">
                      "Browser Forks (Chromium/Firefox)"
                    </span>
                    ,
                  </p>
                  <p>
                  ...
                  <p>
                    {" "}
                    <span className="text-accent-emerald">"C/C++"</span>,{" "}
                    <span className="text-accent-emerald">"Go"</span>,{" "}
                    <span className="text-accent-emerald">"Python"</span>,
                  </p>
                  <p>
                    {" "}
                    <span className="text-accent-emerald">"Rust"</span>,{" "}
            ...
            <div className="bg-black/40 px-4 py-2 border-t border-white/5 shrink-0 flex items-center gap-1.5 text-text-muted font-mono text-[10px]">
              ...
              {activeTab === "terminal" && (
                <span>
                  Tab to autocomplete commands · Up/Down for command history
                </span>
              )}
              {activeTab === "cuda" && (
                <span>
                  MGPUsim strided prefetcher — confidence-based stride detection
                  (Go)
                </span>
              )}
              {activeTab === "json" && (
                <span>Developer JSON profile schema metadata</span>
              )}
            </div>
          </div>
        </div>
