...
export default function ParticleField() {
  ...
  useEffect(() => {
    ...
    const constructionProgress = Array(fgLayer.list.length)
      .fill(0)
      .map(() => Math.random() * 60);
      ...
      while (drawX < canvas.width) {
        fgLayer.list.forEach((b, idx) => {
          ...
          if (b.isUnderConstruction) {
            constructionProgress[idx] =
              (constructionProgress[idx] + currentSpeed * 0.004) % 100;
          }
          ...
          if (x + b.w > 0 && x < canvas.width) {
            ...
            ctx.strokeStyle = b.isUnderConstruction
            ...
            if (b.isUnderConstruction) {
              ...
              const craneAngle =
                Math.sin(Date.now() * 0.001 * currentSpeed) * 8;
